/*
  ADAM masterplan — 70% scroll smoothing
  --------------------------------------
  Keeps Webflow/native scrolling untouched. Only the 3D masterplan's internal
  .h-scroll progress is eased: 70% previous value + 30% new target per frame.
*/
