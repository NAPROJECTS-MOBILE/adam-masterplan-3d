...
export const PRESETS = {
  'Official Light': {
    ...
    edge:'#d6e296', edgeOpacity:0.48, edgeWidth:1.1, edgeAngle:30,
    glow:'#d9ef8e', glowOpacity:0.22, glowWidth:4.0, glowStrength:1.0, glowExpansion:0.0015,
    dotColor:'#d8e89b', dotOpacity:0.32, dotSize:0.16, dotSpacing:1.4, dotSkew:0.5,
    dotBaseOpacity:0.28, rippleSpeed:1.2, rippleFrequency:0.35, rippleWidth:0.5,
    rippleStrength:0.9, rippleOriginX:0, rippleOriginZ:0,
    hemisphere:0.6, key:1.25, rim:0.0, exposure:0.86, keyTint:'#fff6e8'
  },
  'Soft Lime': {
    background:'#f4f6ea',
    ...
    edge:'#b9d24a', edgeOpacity:0.65, edgeWidth:1.4, edgeAngle:30,
    glow:'#c8f542', glowOpacity:0.34, glowWidth:5.2, glowStrength:1.3, glowExpansion:0.002,
    dotColor:'#c8f542', dotOpacity:0.42, dotSize:0.18, dotSpacing:1.2, dotSkew:0.5,
    dotBaseOpacity:0.24, rippleSpeed:1.6, rippleFrequency:0.42, rippleWidth:0.45,
    rippleStrength:1.0, rippleOriginX:0, rippleOriginZ:0,
    hemisphere:0.55, key:1.15, rim:0.0, exposure:0.9, keyTint:'#fffbea'
  },
  'Mono Soft': {
    background:'#eeeeee',
    ...
    glow:'#cfcfcf', glowOpacity:0.16, glowWidth:3.2, glowStrength:0.8, glowExpansion:0.001,
    dotColor:'#b4b4b4', dotOpacity:0.25, dotSize:0.14, dotSpacing:1.6, dotSkew:0.5,
    dotBaseOpacity:0.35, rippleSpeed:0.9, rippleFrequency:0.3, rippleWidth:0.55,
    rippleStrength:0.6, rippleOriginX:0, rippleOriginZ:0,
    hemisphere:0.7, key:1.2, rim:0.0, exposure:0.85, keyTint:'#ffffff'
  },
  'Dark Studio': {
    background:'#14161a',
    ...
    hemisphere:0.35, key:1.5, rim:0.1, exposure:0.95, keyTint:'#eaf3ff'
  }
};

export const CAM = [
  ['azimuth','Azimuth °',-180,180,1], ['elevation','Elevation °',2,89,1],
  ['zoom','Camera distance',0.02,2.5,0.01], ['panX','Pan X',-1.2,1.2,0.01], ['panZ','Pan Z',-1.2,1.2,0.01]
];
export const LIGHT = [
  ['hemisphere','Hemisphere',0,2,0.05], ['key','Key intensity',0,3,0.05],
  ['rim','Directional rim light (global)',0,1.5,0.05], ['exposure','ACES exposure',0.2,1.6,0.01],
